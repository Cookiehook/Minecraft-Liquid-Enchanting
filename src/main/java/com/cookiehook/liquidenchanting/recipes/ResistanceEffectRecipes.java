...
public class ResistanceEffectRecipes {
	...
	public static void addArmorRecipes() {
		...
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.resistance_chainmail_helmet, "ABA", "ACA", "AAA", 'A',
				Blocks.IRON_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_HELMET, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.resistance_chainmail_chestplate, "ABA", "ACA", "AAA", 'A',
				Blocks.IRON_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_CHESTPLATE, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.resistance_chainmail_leggings, "ABA", "ACA", "AAA", 'A',
				Blocks.IRON_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_LEGGINGS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.resistance_chainmail_boots, "ABA", "ACA", "AAA", 'A',
		...
		// ResistanceII Armor
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_leather_helmet, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.LEATHER_HELMET, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_leather_chestplate, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.LEATHER_CHESTPLATE, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_leather_leggings, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.LEATHER_LEGGINGS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_leather_boots, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.LEATHER_BOOTS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_iron_helmet, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.IRON_HELMET, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_iron_chestplate, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.IRON_CHESTPLATE, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_iron_leggings, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.IRON_LEGGINGS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_iron_boots, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.IRON_BOOTS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_chainmail_helmet, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_HELMET, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_chainmail_chestplate, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_CHESTPLATE, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_chainmail_leggings, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_LEGGINGS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_chainmail_boots, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.CHAINMAIL_BOOTS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_golden_helmet, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.GOLDEN_HELMET, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_golden_chestplate, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.GOLDEN_CHESTPLATE, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_golden_leggings, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.GOLDEN_LEGGINGS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_golden_boots, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.GOLDEN_BOOTS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_diamond_helmet, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.DIAMOND_HELMET, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_diamond_chestplate, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.DIAMOND_CHESTPLATE, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_diamond_leggings, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.DIAMOND_LEGGINGS, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_diamond_boots, "ABA", "ACA", "AAA", 'A',
	...
	public static void addSwordRecipes() {
		...
		// ResistanceII Sword
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_wooden_sword, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.WOODEN_SWORD, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_stone_sword, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.STONE_SWORD, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_iron_sword, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.IRON_SWORD, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_golden_sword, "ABA", "ACA", "AAA", 'A',
				Blocks.DIAMOND_BLOCK, 'B', Items.NETHER_STAR, 'C', new ItemStack(Items.GOLDEN_SWORD, 1, OreDictionary.WILDCARD_VALUE)));
		GameRegistry.addRecipe(new ShapedArmorUpgradeRecipe(ResistanceEffectItems.strong_resistance_diamond_sword, "ABA", "ACA", "AAA", 'A',

...
public class SlownessEffectItems {
	...
	public static Item slowness_chainmail_helmet = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 0, Potion.moveSlowdown).setUnlocalizedName("slowness_chainmail_helmet").setTextureName("minecraft:chainmail_helmet");
	public static Item slowness_chainmail_chestplate = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 1, Potion.moveSlowdown).setUnlocalizedName("slowness_chainmail_chestplate").setTextureName("minecraft:chainmail_chestplate");
	public static Item slowness_chainmail_leggings = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 2, Potion.moveSlowdown).setUnlocalizedName("slowness_chainmail_leggings").setTextureName("minecraft:chainmail_leggings");
	public static Item slowness_chainmail_boots = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 3, Potion.moveSlowdown).setUnlocalizedName("slowness_chainmail_boots").setTextureName("minecraft:chainmail_boots");

...
public class InvisibilityEffectItems {
	...
	public static Item invisibility_chain_helmet = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 0, Potion.invisibility).setUnlocalizedName("invisibility_chain_helmet").setTextureName("minecraft:chainmail_helmet");
	public static Item invisibility_chain_chestplate = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 1, Potion.invisibility).setUnlocalizedName("invisibility_chain_chestplate").setTextureName("minecraft:chainmail_chestplate");
	public static Item invisibility_chain_leggings = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 2, Potion.invisibility).setUnlocalizedName("invisibility_chain_leggings").setTextureName("minecraft:chainmail_leggings");
	public static Item invisibility_chain_boots = new ItemPotionArmor(ItemArmor.ArmorMaterial.CHAIN, 1, 3, Potion.invisibility).setUnlocalizedName("invisibility_chain_boots").setTextureName("minecraft:chainmail_boots");

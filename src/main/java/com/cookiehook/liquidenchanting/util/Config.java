...
public class Config {
    ...
    private static void syncConfig() {
        ...
        combinedCraftingEnabled = config.getBoolean("Enable Combined Crafting", category, false,
                "Set to True to allow custom potions to be used as ingredients. " +
                        "This includes combined vanilla potions");
        instantEffectEnabled = config.getBoolean("Enable Instant Effect", category, false,
                "Set to True to allow 'instant' effects like health / damage to be applied to armor. " +
